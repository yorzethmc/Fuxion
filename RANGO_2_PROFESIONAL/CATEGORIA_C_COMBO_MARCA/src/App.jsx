  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-100 font-sans pb-32">
      <header className="p-6 pt-10 text-center border-b border-white/10 bg-zinc-900">
        <p className="text-xs uppercase tracking-[0.25em] text-orange-400 font-black mb-2">Combo Marca</p>
        <h1 className="text-3xl font-black text-white">{restaurant.name}</h1>
        <p className="text-gray-400 font-semibold text-sm uppercase mt-1">Menú, pedidos y presencia lista para campañas</p>
